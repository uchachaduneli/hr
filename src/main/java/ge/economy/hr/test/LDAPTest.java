...
public class LDAPTest {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapAdServer = "ldap://ad1.economy.ge:389";
        final String ldapSearchBase = "DC=economy,DC=ge";

        final String ldapUsername = "economy\\nlomineishvili";
        final String ldapPassword = "1qaz!QAZ";

        final String ldapAccountToLookup = "nlomineishvili";
